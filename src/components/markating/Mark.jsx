...
import objectif from "../../../public/assets/objictif.svg";
...
export default function Mark() {
  return (
    ...
    >
      <div className="w-[80%] h-[233px] sm:h-auto  ps-[80px] sm:ps-0 flex items-center justify-center ">
        <Marquee speed={150} direction="left">
          <div className="w-full lg:h-40 h-full gap-x-14 py-16 justify-between items-start inline-flex ">
            <svg
              width="212"
              height="32"
              viewBox="0 0 212 32"
      ...
      <Image
        ...
        height={169.95}
        width={65}
        className="absolute bottom-[45.3px] lg:left-[38px] left-[10px]"
      />
    </div>
  );
}
